/* Bundle the model into one self-contained HTML file.
   ...
   multi-file version) openable from the iOS Files app.
...
const OUT = join(OUT_DIR, 'cheverny.html')
...
console.log(`\n  dist/cheverny.html  ${kb} kB  (${inlined.length} scripts inlined, no external refs)\n`)
